...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.example.duisen.usefulnotes.NewAppWidget";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==1){
            mAppWidgetText.setText(data.getStringExtra("Note"));
            final Context context = NewAppWidgetConfigureActivity.this;
